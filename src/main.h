...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 RING
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 RING mininput
/** No amount larger than this (in Heo) is valid */
